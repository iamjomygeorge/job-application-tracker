      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-primary to-purple-400 dark:from-white dark:to-white/70">
              JobTracker
            </span>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            {user ? (
              ...
              <div className="flex items-center gap-4">
                <Link
                  href="/login"
                  className="text-sm font-medium text-gray-500 dark:text-gray-300 hover:text-foreground transition-colors"
                >
                  Log In
                </Link>
                <Link
